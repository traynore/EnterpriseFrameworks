...
namespace GWSApp.Controllers
{
    ...
    public class InvoicesController : Controller
    {
       ...
       public ActionResult ExportPdf(int? id)
        ...
        // GET: Invoices/ExportAllPdf
        public ActionResult ExportAllPdf()
        {
            bool pdfSuccess = AllPdfInvoices();
        ...
        // all invoice pdf generator, make a document containing all invoices
        public bool AllPdfInvoices()
        {
            ...
            {
                Document doc = new Document(iTextSharp.text.PageSize.A4, 50, 50, 25, 25);
                var path = AppDomain.CurrentDomain.BaseDirectory + "pdf/" + "invoices.pdf";
                var output = new FileStream(path, FileMode.Create);
                PdfWriter wri = PdfWriter.GetInstance(doc, output);
